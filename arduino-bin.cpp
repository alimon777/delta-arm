// THIS CODE WORKS WITH BIN WHEN RUN FROM APP BUT WITHOUT BIN WHEN RUN FROM PYTHONFILE CODE
...
void loop() {
  ...
  delay(3000);
  if(b==-1 && b1==-1 && b2==-1 && b==-1){
    servo1.write(t1);
    servo2.write(t2);
    servo3.write(t3);
    // here reset the below comment to enable the return to home after one round
    // t1=110;
    // t2=110;
    // t3=110;
  }else{
